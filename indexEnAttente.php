...
<head>
    ...
    <meta name="author" content="Bziit">
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Social Bziiit</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="text-center">
                        <a class="page-scroll" href="#infodujour">L'info du jour</a>
                    </li>
                    <li class="text-center">
                        <a class="page-scroll" href="#sinscrire">S'incrire</a>
                    </li>
                    <li class="text-center">
    ...
    <!-- Contact Section -->
    <section id="sinscrire" class="bg-success">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Inscrivez-vous</h2>
                    <h3 class="section-subheading text-muted">Pour continuer de recevoir gratuitement les données de passage de votre boutique</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; <a href="www.bziiitbooster.com">BziiitBooster</a> 2016</span>
                </div>
                <div class="col-md-4">
